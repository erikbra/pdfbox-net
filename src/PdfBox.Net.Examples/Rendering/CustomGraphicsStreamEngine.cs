...
/// <summary>
/// Example showing how to extend PDFGraphicsStreamEngine to extract low-level graphics operations
/// from a PDF, including path, image, and text operations.
///
/// NOTE: In this .NET port, PDFGraphicsStreamEngine does not yet expose the abstract path/image
/// callback methods from the Java equivalent. Once those are ported, this class should be updated
/// to override AppendRectangle, DrawImage, MoveTo, LineTo, CurveTo, StrokePath, FillPath, etc.
/// </summary>
