...
/// <summary>
/// Adds validation information (LTV) to a PDF signature.
/// </summary>
public class AddValidationInformation
{
    ...
    {
        // NOTE: PDF signature validation requires cryptographic APIs (BouncyCastle, etc.)
        // which are not yet implemented in this .NET port.
        throw new NotSupportedException(
            "PDF signature validation is not yet implemented in this .NET port.");
    }
}
