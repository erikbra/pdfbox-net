 ...
 *
 * PDFBOX_SOURCE_PATH: examples/src/main/java/org/apache/pdfbox/examples/pdmodel/PrintURLs.java
...
/// <summary>
/// This is an example of how to read a document and print all URLs from annotations.
/// </summary>
public class PrintURLs
{
    ...
    public static void Main(string[] args)
    {
        if (args.Length != 1)
        {
            Console.Error.WriteLine("usage: PrintURLs <input-pdf>");
            return;
        }
            ...
            for (int pageNum = 0; pageNum < document.GetNumberOfPages(); pageNum++)
            {
                ...
                foreach (PDAnnotation annotation in page.GetAnnotations())
                {
                    if (annotation is PDAnnotationLink linkAnnotation)
                    {
                        ...
                        {
                            Console.WriteLine("Page " + (pageNum + 1) + ": " + uriAction.GetURI());
                        }
                    }
                }
            }
