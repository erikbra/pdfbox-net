 ...
 *
 * PDFBOX_SOURCE_PATH: examples/src/main/java/org/apache/pdfbox/examples/interactive/form/CreateRadioButtons.java
...
/// <summary>
/// Example for creating radio button AcroForm widgets.
/// </summary>
public class CreateRadioButtons
{
    ...
    public static void Main(string[] args)
    {
        using (PDDocument document = new PDDocument())
        {
            ...
            radioButton.SetPartialName("radioGroup");
            ...
            document.Save("radiobuttons.pdf");
        }
    }
}
