...
/// <summary>
/// Example for creating a simple AcroForm PDF from scratch.
/// </summary>
public class CreateSimpleForm
{
    ...
    public static void Main(string[] args)
    {
        using (PDDocument document = new PDDocument())
        {
            ...
            // NOTE: PDPageContentStream text drawing operators needed for AP stream creation
            // are not yet implemented in this .NET port. The AcroForm field is created without
            // a visual appearance.

            PDRectangle fieldArea = new PDRectangle(50, 750, 200, 20);
            ...
            textBox.SetValue("Sample field value");
