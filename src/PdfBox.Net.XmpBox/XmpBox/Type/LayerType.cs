 ...
 *
 * PDFBOX_SOURCE_PATH: xmpbox/src/main/java/org/apache/xmpbox/type/LayerType.java
...
public partial class LayerType : AbstractStructuredType
{
    ...
    [PropertyType(XmpTypeName.Text)]
    public static readonly string LAYER_TEXT = "LayerText";
    ...
    {
        return GetFirstEquivalentProperty(LAYER_NAME, typeof(TextType)) is TextType absProp ? absProp.GetStringValue() : null;
    }

    public void SetLayerName(string image)
    {
        AddProperty(CreateTextType(LAYER_NAME, image));
    }

    public string? GetLayerText()
    {
        return GetFirstEquivalentProperty(LAYER_TEXT, typeof(TextType)) is TextType absProp ? absProp.GetStringValue() : null;
    }
