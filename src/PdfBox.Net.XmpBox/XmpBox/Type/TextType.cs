 ...
 *
 * PDFBOX_SOURCE_PATH: xmpbox/src/main/java/org/apache/xmpbox/type/TextType.java
...
public class TextType : AbstractSimpleProperty
{
    ...
    public override void SetValue(object value)
    {
        ...
        {
            throw new ArgumentException($"Value given is not allowed for the Text type : '{value}'");
        }
