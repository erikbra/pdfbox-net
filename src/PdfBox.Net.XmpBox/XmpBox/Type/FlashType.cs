 ...
 *
 * PDFBOX_SOURCE_PATH: xmpbox/src/main/java/org/apache/xmpbox/type/FlashType.java
...
public class FlashType : AbstractStructuredType
{
    [PropertyType(XmpTypeName.Boolean)]
    public static readonly string FIRED = "Fired";

    [PropertyType(XmpTypeName.Boolean)]
    public static readonly string FUNCTION = "Function";

    [PropertyType(XmpTypeName.Boolean)]
    public static readonly string RED_EYE_MODE = "RedEyeMode";
