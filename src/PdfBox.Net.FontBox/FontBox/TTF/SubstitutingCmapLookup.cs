 ...
 *
 * PDFBOX_SOURCE_PATH: fontbox/src/main/java/org/apache/fontbox/ttf/SubstitutingCmapLookup.java
...
internal class SubstitutingCmapLookup(CmapLookup cmap, GlyphSubstitutionTable gsub, IReadOnlyList<string> enabledFeatures) : CmapLookup
{
