 ...
 *
 * PDFBOX_SOURCE_PATH: fontbox/src/main/java/org/apache/fontbox/ttf/gsub/GsubWorkerForGujarati.java
...
public class GsubWorkerForGujarati : IGsubWorker
{
    ...
    // Reph glyphs
    private static readonly char[] RephChars = { '\u0AB0', '\u0ACD' };
    // Glyphs to precede reph
    private static readonly char[] BeforeRephChars = { '\u0ABE', '\u0ABF' };
    ...
    internal GsubWorkerForGujarati(CmapLookup cmapLookup, IGsubData gsubData)
    {
