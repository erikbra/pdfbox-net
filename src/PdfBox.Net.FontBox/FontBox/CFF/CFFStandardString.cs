 ...
 *
 * PDFBOX_SOURCE_PATH: fontbox/src/main/java/org/apache/fontbox/cff/CFFStandardString.java
...
public static class CFFStandardString
{
    ...
    private static readonly Dictionary<string, int> NameToSid = StandardStrings
    ...
    {
        return sid >= 0 && sid < StandardStrings.Length ? StandardStrings[sid] : $"sid{sid}";
    }
