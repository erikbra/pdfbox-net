 ...
 * PDFBOX_SOURCE_COMMIT: 8d86a73a318627b91f02162cd39d97a11662a50c
 * PORT_MODE: adapted
 * PORT_LAST_SYNC_COMMIT: 8d86a73a318627b91f02162cd39d97a11662a50c
 */
...
public static class CFFOperator
{
    ...
    private static void Register(int b0, string name) => Register(b0, 0, name);

    private static void Register(int b0, int b1, string name) => KeyMap[CalculateKey(b0, b1)] = name;
    ...
    {
        return KeyMap.TryGetValue(CalculateKey(b0, b1), out string? name) ? name : null;
    }
}
