...
public class AFMParser
{
    ...
    private const string CHARMETRIC_C = CHARMETRICS_C;
    private const string CHARMETRIC_CH = CHARMETRICS_CH;
    private const string CHARMETRIC_WX = CHARMETRICS_WX;
    private const string CHARMETRIC_W0X = CHARMETRICS_W0X;
    private const string CHARMETRIC_W1X = CHARMETRICS_W1X;
    private const string CHARMETRIC_WY = CHARMETRICS_WY;
    private const string CHARMETRIC_W0Y = CHARMETRICS_W0Y;
    private const string CHARMETRIC_W1Y = CHARMETRICS_W1Y;
    private const string CHARMETRIC_W = CHARMETRICS_W;
    private const string CHARMETRIC_W0 = CHARMETRICS_W0;
    private const string CHARMETRIC_W1 = CHARMETRICS_W1;
    private const string CHARMETRIC_VV = CHARMETRICS_VV;
    private const string CHARMETRIC_N = CHARMETRICS_N;
    private const string CHARMETRIC_B = CHARMETRICS_B;
    private const string CHARMETRIC_L = CHARMETRICS_L;
