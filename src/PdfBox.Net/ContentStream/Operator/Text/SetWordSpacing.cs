 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/text/SetWordSpacing.java
...
/// <summary>
/// Processes the PDF "Tw" operator: set the word spacing.
/// </summary>
