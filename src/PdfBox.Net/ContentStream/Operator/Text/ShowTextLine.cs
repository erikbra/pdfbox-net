 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/text/ShowTextLine.java
...
/// <summary>
/// Processes the PDF "'" operator: move to the next line and show a text string.
