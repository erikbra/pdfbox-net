 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/text/ShowTextLineAndSpace.java
...
/// <summary>
/// Processes the PDF '"' operator: set word and character spacing, move to the
/// next line, and show a text string.
/// Equivalent to setting Tw and Tc then executing "'".
/// </summary>
