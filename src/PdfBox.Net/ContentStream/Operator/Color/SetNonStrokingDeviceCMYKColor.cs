 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/color/SetNonStrokingDeviceCMYKColor.java
...
public sealed class SetNonStrokingDeviceCMYKColor : OperatorProcessor
{
    ...
    public override void Process(Operator op, IList<COSBase> operands)
    {
        ...
        Context.SetNonStrokingColor(new PDColor([c.FloatValue(), m.FloatValue(), y.FloatValue(), k.FloatValue()], colorSpace));
    }
}
