 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/graphics/CloseFillNonZeroAndStrokePath.java
...
public sealed class CloseFillNonZeroAndStrokePath : OperatorProcessor
{
    private readonly ClosePath _closePath;
    private readonly FillNonZeroAndStrokePath _fillNonZeroAndStrokePath;

    public CloseFillNonZeroAndStrokePath(PDFStreamEngine context)
        : base(OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, context)
    {
