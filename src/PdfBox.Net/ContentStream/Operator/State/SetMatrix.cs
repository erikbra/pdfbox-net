 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/contentstream/operator/state/SetMatrix.java
...
/// <summary>
/// Processes the PDF "Tm" operator: set the text matrix and text line matrix.
/// Both matrices are set to the matrix formed by the six operands.
/// </summary>
