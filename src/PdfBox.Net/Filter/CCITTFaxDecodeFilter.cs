...
public sealed class CCITTFaxDecodeFilter : Filter
{
    ...
    {
        throw new NotSupportedException("CCITTFaxDecode is not yet implemented in PdfBox.Net.");
    }

    public override void Encode(Stream input, Stream output, COSDictionary parameters, int index)
    {
        throw new NotSupportedException("CCITTFax encoding is not yet implemented in PdfBox.Net.");
    }
}
