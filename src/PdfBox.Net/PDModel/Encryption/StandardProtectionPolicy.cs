 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/encryption/StandardProtectionPolicy.java
...
public sealed partial class StandardProtectionPolicy : ProtectionPolicy
{
    ...
    public AccessPermission GetPermissions() => _permissions;
    public void SetPermissions(AccessPermission permissions) => _permissions = permissions;

    public string GetOwnerPassword() => _ownerPassword;
    public void SetOwnerPassword(string ownerPassword) => _ownerPassword = ownerPassword;
