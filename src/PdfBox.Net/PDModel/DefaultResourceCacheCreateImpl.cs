 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/DefaultResourceCacheCreateImpl.java
...
/// <summary>
/// Creates <see cref="DefaultResourceCache"/> instances.
/// </summary>
public class DefaultResourceCacheCreateImpl
{
    ...
    {
        return new DefaultResourceCache(_stableCacheEnabled);
    }
}
