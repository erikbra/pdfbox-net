 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/font/FontMappers.java
...
{
    private static readonly Lazy<FontMapper> DefaultInstance = new(() => new FontMapperImpl());
