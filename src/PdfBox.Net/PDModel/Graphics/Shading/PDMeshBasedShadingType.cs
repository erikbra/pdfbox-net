 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/graphics/shading/PDMeshBasedShadingType.java
...
/// <para>
/// Note: stream-based patch collection methods (collectPatches, readPatch, generatePatch) are
