...
public static class CCITTFactory
{
    ...
    {
        throw new NotImplementedException("CCITTFactory.CreateFromFile is not yet implemented.");
    }
    ...
    {
        throw new NotImplementedException("CCITTFactory.CreateFromStream is not yet implemented.");
    }
}
