 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/graphics/color/PDDeviceGray.java
...
public sealed class PDDeviceGray : PDColorSpace
{
    ...
    private PDDeviceGray() : base(DeviceGray)
    {
        _initialColor = new PDColor([0f], this);
    }

    public override string GetName() => DeviceGray.GetName();
