 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/common/PDDictionaryWrapper.java
...
public class PDDictionaryWrapper : COSObjectable
{
    ...
    {
        return ReferenceEquals(this, obj) || (obj is PDDictionaryWrapper other && _dictionary.Equals(other._dictionary));
    }
