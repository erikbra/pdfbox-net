 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/interactive/annotation/handlers/PDPolygonAppearanceHandler.java
...
{
    public PDPolygonAppearanceHandler(PDAnnotation annotation, PDDocument? document = null)
