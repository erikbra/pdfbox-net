 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/interactive/action/PDPageAdditionalActions.java
...
public class PDPageAdditionalActions : COSObjectable
{
    ...
    public PDAction? GetO() => GetAction(OName);
    public void SetO(PDAction? action) => _actions.SetItem(OName, action);
