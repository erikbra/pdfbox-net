 ...
 *
 * PDFBOX_SOURCE_PATH: pdfbox/src/main/java/org/apache/pdfbox/pdmodel/interactive/action/PDAdditionalActions.java
...
public class PDAdditionalActions : COSObjectable
{
    ...
    {
        return PDActionFactory.CreateAction(_actions.GetCOSDictionary(COSName.F));
    }
    ...
    {
        _actions.SetItem(COSName.F, action);
    }
}
