...
fixtures=(
  "$root/tests/PdfBox.Net.Tests/Fixtures/classic-xref-fixture.pdf"
  "$root/tests/PdfBox.Net.Tests/Fixtures/encrypted-owner-restricted.pdf"
  "$root/tests/PdfBox.Net.Tests/Fixtures/with_outline.pdf"
)
