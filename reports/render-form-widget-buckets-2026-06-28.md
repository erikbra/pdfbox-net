...
Issue: #558 (follow-up to #541)

Source: GitHub Actions runtime-parity artifact from PR #574 run 28339243565, reclassified with #558 form-widget BBox clipping bucket
Runtime parity output: `artifacts/runtime-parity-issue-558-reclassified`
Runtime comparison generated UTC: `2026-06-28T23:29:19Z`
...
|---|---:|---:|---:|
| `render-form-widget-bbox-clipping-equivalence-match` | 0 | 1 | 1 |
| `render-form-widget-raster-equivalence-match` | 3 | 2 | 2 |
