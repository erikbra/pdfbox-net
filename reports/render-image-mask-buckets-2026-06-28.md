...
Issue: #559 (follow-up to #541)

Source: GitHub Actions runtime-parity artifact from PR #575 run 28339983665, reclassified with #559 JBIG2 decoder raster bucket
Runtime parity output: `artifacts/runtime-parity-issue-559-reclassified`
Runtime comparison generated UTC: `2026-06-28T23:59:00Z`
...
|---|---:|---:|---:|
| `render-image-mask-shape-equivalence-match` | 3 | 2 | 2 |
| `render-jbig2-decoder-raster-equivalence-match` | 0 | 1 | 1 |
