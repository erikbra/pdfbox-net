 ...
 *
 * PDFBOX_SOURCE_PATH: fontbox/src/test/java/org/apache/fontbox/cff/DataInputTest.java
...
public class CFFDataInputTest
{
    ...
    public void TestReadBytes()
    {
        ...
        Assert.Throws<IOException>(() => dataInput.ReadBytes(20));
        ...
        Assert.Throws<IOException>(() => dataInput.ReadBytes(5));
    }
