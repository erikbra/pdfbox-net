 ...
 *
 * PDFBOX_SOURCE_PATH: io/src/test/java/org/apache/pdfbox/io/RandomAccessReadMemoryMappedFileTest.java
...
/// <summary>
/// Unittest for <see cref="RandomAccessReadMemoryMappedFile"/>.
/// </summary>
public class RandomAccessReadMemoryMappedFileTest : IDisposable
{
    ...
    public RandomAccessReadMemoryMappedFileTest()
    {
    ...
    public void TestPositionSkip()
    {
        using RandomAccessRead randomAccessSource =
            new RandomAccessReadMemoryMappedFile(_file1Path);
    ...
    {
        using RandomAccessRead randomAccessSource =
            new RandomAccessReadMemoryMappedFile(new FileInfo(_file1Path));
    ...
    {
        RandomAccessRead randomAccessSource =
            new RandomAccessReadMemoryMappedFile(_file1Path);
    ...
    {
        using RandomAccessRead randomAccessSource =
            new RandomAccessReadMemoryMappedFile(_emptyFilePath);
        Assert.Equal(-1, randomAccessSource.Read());
