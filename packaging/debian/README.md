...
`https://erikbra.github.io/pdfbox-net/apt`. Install the preview channel with:

```console
sudo install -d -m 0755 /etc/apt/keyrings
curl -fsSL https://erikbra.github.io/pdfbox-net/apt/unpdf-archive-keyring.gpg \
  | sudo tee /etc/apt/keyrings/unpdf.gpg >/dev/null
curl -fsSL https://erikbra.github.io/pdfbox-net/apt/unpdf-preview.sources \
