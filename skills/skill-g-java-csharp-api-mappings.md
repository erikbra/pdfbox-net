...
## 11. Logging – Apache Commons Logging / Log4j / SLF4J
...
| Java | C# |
|---|---|
| `private static final Log LOG = LogFactory.getLog(X.class)` | `private static ILogger<X> LOG => PdfBoxLogging.CreateLogger<X>();` |
