...
- **Header blank line**: In the provenance comment block at the top of each file, add a blank comment line (` *`) between the copyright line and the next line (e.g. "Mechanically converted..." or descriptive text).
